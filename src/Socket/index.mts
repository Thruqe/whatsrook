...
import { DEFAULT_CONNECTION_CONFIG } from "../Defaults/index.mts";
import type {
	BinaryNode,
	ConnectionState,
	Contact,
...
import { DisconnectReason } from "../Types/index.mts";
import { Boom } from "../Utils/boom.mts";
import { makeEventBuffer } from "../Utils/event-buffer.mts";
import type { ILogger } from "../Utils/logger.mts";
import {
	_registerActiveBridgeClient,
	downloadMediaMessage
} from "../Utils/messages.mts";
import type { MediaDownloadOptions } from "../Utils/messages-media.mts";
import { makeBlockingMethods } from "./blocking.mts";
import { makeChatActionMethods } from "./chat-actions.mts";
import { makeContactMethods } from "./contacts.mts";
import { makeEventHandler } from "./events.mts";
import { makeGroupMethods } from "./groups.mts";
import { makeMessageMethods } from "./messages.mts";
import { makeNewsletterMethods } from "./newsletter.mts";
import { makePresenceMethods } from "./presence.mts";
import { makeProfileMethods } from "./profile.mts";
import { mapReachoutTimelock } from "./reachout.mts";
import { makeHttpClient, makeTransport } from "./transport.mts";
import type { SocketContext } from "./types.mts";
import { makeCryptoProvider } from "../Utils/crypto-provider.mts";
import { assertNodeErrorFree } from "../Utils/generic-util.mts";
...
const makeWASocket = (config: UserFacingSocketConfig) => {
	...
	const sock = {
		...
		waitForMessage: <T extends unknown = BinaryNode>(
			msgId: string,
			timeoutMs?: number
		): Promise<T> => {
