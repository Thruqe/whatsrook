...
import { processHistoryMessage } from "../Utils/process-history-message.mts";
import type {
	CanonicalCallAction,
...
const RECEIPT_TYPE_MAP: Record<
	string,
	NonNullable<import("./types.mts").CanonicalReceipt["receiptType"]>
> = {
	Delivered: "delivered",
	Sender: "sender",
	Retry: "retry",
...
const parseReceiptType = (
	raw: unknown
): import("./types.mts").CanonicalReceipt["receiptType"] => {
	const norm =
		typeof raw === "string"
			? raw
