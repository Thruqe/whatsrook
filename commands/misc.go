...
func handleSave(ctx *Context) error {
	...
	if quoted == nil {
		return ctx.Reply("ℹ️ The basic functionality of this command is to save status updates. Please reply to a status update or any message to forward it to your DM.")
	}
