...
type AISubscriptionRequestType int32

const (
	AISubscriptionRequestType_UNSPECIFIED AISubscriptionRequestType = 0
	AISubscriptionRequestType_THINK_HARD  AISubscriptionRequestType = 1
	AISubscriptionRequestType_IMAGE_GEN   AISubscriptionRequestType = 2
	AISubscriptionRequestType_VIDEO_GEN   AISubscriptionRequestType = 3
)

// Enum value maps for AISubscriptionRequestType.
var (
	AISubscriptionRequestType_name = map[int32]string{
		0: "UNSPECIFIED",
		1: "THINK_HARD",
		2: "IMAGE_GEN",
		3: "VIDEO_GEN",
	}
	AISubscriptionRequestType_value = map[string]int32{
		"UNSPECIFIED": 0,
		"THINK_HARD":  1,
		"IMAGE_GEN":   2,
		"VIDEO_GEN":   3,
...
func (x AISubscriptionRequestType) Enum() *AISubscriptionRequestType {
	p := new(AISubscriptionRequestType)
	*p = x
	return p
}

func (x AISubscriptionRequestType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (AISubscriptionRequestType) Descriptor() protoreflect.EnumDescriptor {
	return file_waAICommon_WAWebProtobufsAICommon_proto_enumTypes[3].Descriptor()
}

func (AISubscriptionRequestType) Type() protoreflect.EnumType {
	return &file_waAICommon_WAWebProtobufsAICommon_proto_enumTypes[3]
}

func (x AISubscriptionRequestType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *AISubscriptionRequestType) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = AISubscriptionRequestType(num)
	return nil
}

// Deprecated: Use AISubscriptionRequestType.Descriptor instead.
func (AISubscriptionRequestType) EnumDescriptor() ([]byte, []int) {
...
const (
	...
	BotSignatureVerificationUseCaseProof_P2P_PILLS      BotSignatureVerificationUseCaseProof_BotSignatureUseCase = 3
)
...
const (
	...
	AIHomeState_AIHomeOption_OPEN_GREETING_CARD AIHomeState_AIHomeOption_AIHomeActionType = 5
)
...
func (x *HatchMetadataSync) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *HatchMetadataSync) GetTimestampMS() int64 {
...
func (x *HatchMetadataSync) GetRequestID() string {
	if x != nil && x.RequestID != nil {
		return *x.RequestID
	}
	return ""
...
func (x *AIMetadataOperation) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type BotCommandMetadata struct {
	...
	CommandDescription *string                `protobuf:"bytes,2,opt,name=commandDescription" json:"commandDescription,omitempty"`
	CommandPrompt      *string                `protobuf:"bytes,3,opt,name=commandPrompt" json:"commandPrompt,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *BotCommandMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BotCommandMetadata) GetCommandDescription() string {
	if x != nil && x.CommandDescription != nil {
		return *x.CommandDescription
	}
	return ""
}

func (x *BotCommandMetadata) GetCommandPrompt() string {
	if x != nil && x.CommandPrompt != nil {
		return *x.CommandPrompt
	}
	return ""
}

type BotResolvedToolCallMetadata struct {
	state                    protoimpl.MessageState `protogen:"open.v1"`
	ToolCallID               *string                `protobuf:"bytes,1,opt,name=toolCallID" json:"toolCallID,omitempty"`
	ResolutionDataSerialized *string                `protobuf:"bytes,2,opt,name=resolutionDataSerialized" json:"resolutionDataSerialized,omitempty"`
	unknownFields            protoimpl.UnknownFields
	sizeCache                protoimpl.SizeCache
}
...
func (x *BotResolvedToolCallMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *BotResolvedToolCallMetadata) GetResolutionDataSerialized() string {
	if x != nil && x.ResolutionDataSerialized != nil {
		return *x.ResolutionDataSerialized
	}
	return ""
}

type BotPttPromptMetadata struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *BotPttPromptMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type BotMetadata struct {
	...
	CommandMetadata              *BotCommandMetadata               `protobuf:"bytes,39,opt,name=commandMetadata" json:"commandMetadata,omitempty"`
	ResolvedToolCallMetadata     *BotResolvedToolCallMetadata      `protobuf:"bytes,40,opt,name=resolvedToolCallMetadata" json:"resolvedToolCallMetadata,omitempty"`
...
func (x *BotMetadata) GetCommandMetadata() *BotCommandMetadata {
	if x != nil {
...
func (x *BotMetadata) GetResolvedToolCallMetadata() *BotResolvedToolCallMetadata {
	if x != nil {
		return x.ResolvedToolCallMetadata
	}
	return nil
}

func (x *BotMetadata) GetSubscriptionUpsellMetadata() *AISubscriptionUpsellMetadata {
	if x != nil {
		return x.SubscriptionUpsellMetadata
	}
	return nil
}

func (x *BotMetadata) GetPttPromptMetadata() *BotPttPromptMetadata {
	if x != nil {
		return x.PttPromptMetadata
	}
	return nil
}

func (x *BotMetadata) GetBotHistoryShareMetadata() *BotHistoryShareMetadata {
	if x != nil {
		return x.BotHistoryShareMetadata
	}
	return nil
}
...
type AISubscriptionUpsellMetadata struct {
	state         protoimpl.MessageState     `protogen:"open.v1"`
	RequestType   *AISubscriptionRequestType `protobuf:"varint,1,opt,name=requestType,enum=WAWebProtobufsAICommon.AISubscriptionRequestType" json:"requestType,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AISubscriptionUpsellMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AISubscriptionUpsellMetadata) GetRequestType() AISubscriptionRequestType {
	...
	return AISubscriptionRequestType_UNSPECIFIED
}
...
type BotHistoryShareMetadata struct {
	state                protoimpl.MessageState         `protogen:"open.v1"`
	ParticipantsMetadata []*BotGroupParticipantMetadata `protobuf:"bytes,1,rep,name=participantsMetadata" json:"participantsMetadata,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
...
func (x *BotHistoryShareMetadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type BotAgentDeepLinkMetadata struct {
	...
	ClientPublicKey []byte                 `protobuf:"bytes,2,opt,name=clientPublicKey" json:"clientPublicKey,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *BotAgentDeepLinkMetadata) GetClientPublicKey() []byte {
	if x != nil {
...
type AIProvenance struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	C2PaMetadata  *AIProvenance_Metadata `protobuf:"bytes,1,opt,name=c2PaMetadata" json:"c2PaMetadata,omitempty"`
	IptcMetadata  *AIProvenance_Metadata `protobuf:"bytes,2,opt,name=iptcMetadata" json:"iptcMetadata,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AIProvenance) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AIProvenance) GetC2PaMetadata() *AIProvenance_Metadata {
	if x != nil {
		return x.C2PaMetadata
	}
	return nil
}

func (x *AIProvenance) GetIptcMetadata() *AIProvenance_Metadata {
	if x != nil {
		return x.IptcMetadata
	}
	return nil
}
...
type AIProvenance_Metadata struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	CreatedWithGenAi *bool                  `protobuf:"varint,1,opt,name=createdWithGenAi" json:"createdWithGenAi,omitempty"`
	EditedWithGenAi  *bool                  `protobuf:"varint,2,opt,name=editedWithGenAi" json:"editedWithGenAi,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AIProvenance_Metadata) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *AIProvenance_Metadata) GetCreatedWithGenAi() bool {
	if x != nil && x.CreatedWithGenAi != nil {
		return *x.CreatedWithGenAi
	}
	return false
}

func (x *AIProvenance_Metadata) GetEditedWithGenAi() bool {
	if x != nil && x.EditedWithGenAi != nil {
		return *x.EditedWithGenAi
	}
	return false
}
...
const file_waAICommon_WAWebProtobufsAICommon_proto_rawDesc = "" +
	...
	"\x1aBOT_LINKED_ACCOUNT_TYPE_1P\x10\x00\"\xd1\x02\n" +
	...
	"\x1eRICH_RESPONSE_UR_IMAGINE_VIDEO\x109\x12\x18\n" +
	...
	"\x15BOT_FEEDBACK_NEGATIVE\x10\x0e\"\xc2\x01\n" +
	...
	"\x0eOCR_AND_IMAGES\x10\x01\"\xdf\x05\n" +
	"\vAIHomeState\x12$\n" +
	...
	"\x13conversationOptions\x18\x03 \x03(\v20.WAWebProtobufsAICommon.AIHomeState.AIHomeOptionR\x13conversationOptions\x1a\xe5\x03\n" +
	"\fAIHomeOption\x12U\n" +
	...
	"\vCOLLABORATE\x10\x04\x12\x16\n" +
	"\x12OPEN_GREETING_CARD\x10\x05\"\xe1\x01\n" +
	...
	"\x14surveyCtaHasRendered\x18\x02 \x01(\bR\x14surveyCtaHasRendered\"k\n" +
	"\x19AIMediaCollectionMetadata\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\tR\fcollectionID\x12*\n" +
	"\x10uploadOrderIndex\x18\x02 \x01(\rR\x10uploadOrderIndex\"\x9a\x01\n" +
	"\x18AIMediaCollectionMessage\x12\"\n" +
	"\fcollectionID\x18\x01 \x01(\tR\fcollectionID\x12.\n" +
	"\x12expectedMediaCount\x18\x02 \x01(\rR\x12expectedMediaCount\x12*\n" +
	"\x10hasGlobalCaption\x18\x03 \x01(\bR\x10hasGlobalCaption\"g\n" +
	...
	"\rcommandPrompt\x18\x03 \x01(\tR\rcommandPrompt\"y\n" +
	"\x1bBotResolvedToolCallMetadata\x12\x1e\n" +
	"\n" +
	"toolCallID\x18\x01 \x01(\tR\n" +
	"toolCallID\x12:\n" +
	"\x18resolutionDataSerialized\x18\x02 \x01(\tR\x18resolutionDataSerialized\"6\n" +
	...
	"\x19aiMediaCollectionMetadata\x18& \x01(\v21.WAWebProtobufsAICommon.AIMediaCollectionMetadataR\x19aiMediaCollectionMetadata\x12T\n" +
	"\x0fcommandMetadata\x18' \x01(\v2*.WAWebProtobufsAICommon.BotCommandMetadataR\x0fcommandMetadata\x12o\n" +
	...
	"\x14participantsMetadata\x18\x01 \x03(\v23.WAWebProtobufsAICommon.BotGroupParticipantMetadataR\x14participantsMetadata\"\x82\x01\n" +
	"\x17BotHistoryShareMetadata\x12g\n" +
	...
	"\fforwardScore\x18\x02 \x01(\rR\fforwardScore\"3\n" +
	...
	"\x17sessionTransparencyType\x18\x03 \x01(\x0e2/.WAWebProtobufsAICommon.SessionTransparencyTypeR\x17sessionTransparencyType\"p\n" +
	"\x10BotAgentMetadata\x12\\\n" +
	"\x10deepLinkMetadata\x18\x01 \x01(\v20.WAWebProtobufsAICommon.BotAgentDeepLinkMetadataR\x10deepLinkMetadata\"Z\n" +
	"\x18BotAgentDeepLinkMetadata\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12(\n" +
	"\x0fclientPublicKey\x18\x02 \x01(\fR\x0fclientPublicKey\"\x96\x02\n" +
	"\fAIProvenance\x12Q\n" +
	"\fc2PaMetadata\x18\x01 \x01(\v2-.WAWebProtobufsAICommon.AIProvenance.MetadataR\fc2PaMetadata\x12Q\n" +
	...
	"\x0fAI_HOME_SESSION\x10\a*Z\n" +
	"\x19AISubscriptionRequestType\x12\x0f\n" +
	"\vUNSPECIFIED\x10\x00\x12\x0e\n" +
	"\n" +
...
var file_waAICommon_WAWebProtobufsAICommon_proto_msgTypes = make([]protoimpl.MessageInfo, 79)
var file_waAICommon_WAWebProtobufsAICommon_proto_goTypes = []any{
	...
	(AISubscriptionRequestType)(0),                                                    // 3: WAWebProtobufsAICommon.AISubscriptionRequestType
	(SessionTransparencyType)(0),                                                      // 4: WAWebProtobufsAICommon.SessionTransparencyType
	(BotPluginMetadata_PluginType)(0),                                                 // 5: WAWebProtobufsAICommon.BotPluginMetadata.PluginType
	(BotPluginMetadata_SearchProvider)(0),                                             // 6: WAWebProtobufsAICommon.BotPluginMetadata.SearchProvider
	(BotLinkedAccount_BotLinkedAccountType)(0),                                        // 7: WAWebProtobufsAICommon.BotLinkedAccount.BotLinkedAccountType
	(BotSignatureVerificationUseCaseProof_BotSignatureUseCase)(0),                     // 8: WAWebProtobufsAICommon.BotSignatureVerificationUseCaseProof.BotSignatureUseCase
	(BotPromotionMessageMetadata_BotPromotionType)(0),                                 // 9: WAWebProtobufsAICommon.BotPromotionMessageMetadata.BotPromotionType
	(BotMediaMetadata_OrientationType)(0),                                             // 10: WAWebProtobufsAICommon.BotMediaMetadata.OrientationType
	(BotReminderMetadata_ReminderFrequency)(0),                                        // 11: WAWebProtobufsAICommon.BotReminderMetadata.ReminderFrequency
	(BotReminderMetadata_ReminderAction)(0),                                           // 12: WAWebProtobufsAICommon.BotReminderMetadata.ReminderAction
	(BotModelMetadata_PremiumModelStatus)(0),                                          // 13: WAWebProtobufsAICommon.BotModelMetadata.PremiumModelStatus
	(BotModelMetadata_ModelType)(0),                                                   // 14: WAWebProtobufsAICommon.BotModelMetadata.ModelType
	(BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotSearchSourceProvider)(0), // 15: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotSearchSourceProvider
	(BotProgressIndicatorMetadata_BotPlanningStepMetadata_PlanningStepStatus)(0),      // 16: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.PlanningStepStatus
	(BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourcesMetadata_BotPlanningSearchSourceProvider)(0), // 17: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata.BotPlanningSearchSourceProvider
	(BotCapabilityMetadata_BotCapabilityType)(0),                 // 18: WAWebProtobufsAICommon.BotCapabilityMetadata.BotCapabilityType
	(BotModeSelectionMetadata_BotUserSelectionMode)(0),           // 19: WAWebProtobufsAICommon.BotModeSelectionMetadata.BotUserSelectionMode
	(BotQuotaMetadata_BotFeatureQuotaMetadata_BotFeatureType)(0), // 20: WAWebProtobufsAICommon.BotQuotaMetadata.BotFeatureQuotaMetadata.BotFeatureType
	(BotImagineMetadata_ImagineType)(0),                          // 21: WAWebProtobufsAICommon.BotImagineMetadata.ImagineType
	(BotAgeCollectionMetadata_AgeCollectionType)(0),              // 22: WAWebProtobufsAICommon.BotAgeCollectionMetadata.AgeCollectionType
	(BotSourcesMetadata_BotSourceItem_SourceProvider)(0),         // 23: WAWebProtobufsAICommon.BotSourcesMetadata.BotSourceItem.SourceProvider
	(BotMessageOrigin_BotMessageOriginType)(0),                   // 24: WAWebProtobufsAICommon.BotMessageOrigin.BotMessageOriginType
	(AIThreadInfo_AIThreadClientInfo_AIThreadType)(0),            // 25: WAWebProtobufsAICommon.AIThreadInfo.AIThreadClientInfo.AIThreadType
	(BotFeedbackMessage_ReportKind)(0),                           // 26: WAWebProtobufsAICommon.BotFeedbackMessage.ReportKind
	(BotFeedbackMessage_BotFeedbackKindMultiplePositive)(0),      // 27: WAWebProtobufsAICommon.BotFeedbackMessage.BotFeedbackKindMultiplePositive
	(BotFeedbackMessage_BotFeedbackKindMultipleNegative)(0),      // 28: WAWebProtobufsAICommon.BotFeedbackMessage.BotFeedbackKindMultipleNegative
	(BotFeedbackMessage_BotFeedbackKind)(0),                      // 29: WAWebProtobufsAICommon.BotFeedbackMessage.BotFeedbackKind
	...
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata)(nil), // 88: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourcesMetadata)(nil),                                   // 89: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningStepSectionMetadata)(nil),                                     // 90: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningStepSectionMetadata
	(*BotProgressIndicatorMetadata_BotPlanningStepMetadata_BotPlanningSearchSourceMetadata)(nil),                                    // 91: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourceMetadata
	(*BotQuotaMetadata_BotFeatureQuotaMetadata)(nil),                                                                                // 92: WAWebProtobufsAICommon.BotQuotaMetadata.BotFeatureQuotaMetadata
	(*BotSourcesMetadata_BotSourceItem)(nil),                                                                                        // 93: WAWebProtobufsAICommon.BotSourcesMetadata.BotSourceItem
	(*AIThreadInfo_AIThreadClientInfo)(nil),                                                                                         // 94: WAWebProtobufsAICommon.AIThreadInfo.AIThreadClientInfo
	(*AIThreadInfo_AIThreadServerInfo)(nil),                                                                                         // 95: WAWebProtobufsAICommon.AIThreadInfo.AIThreadServerInfo
	(*BotFeedbackMessage_SideBySideSurveyMetadata)(nil),                                                                             // 96: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SidebySideSurveyMetaAiAnalyticsData)(nil),                                         // 97: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SideBySideSurveyAnalyticsData)(nil),                                               // 98: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SideBySideSurveyAnalyticsData
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SidebySideSurveyMetaAiAnalyticsData_SideBySideSurveyAbandonEventData)(nil),        // 99: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyAbandonEventData
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SidebySideSurveyMetaAiAnalyticsData_SideBySideSurveyResponseEventData)(nil),       // 100: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyResponseEventData
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SidebySideSurveyMetaAiAnalyticsData_SideBySideSurveyCardImpressionEventData)(nil), // 101: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyCardImpressionEventData
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SidebySideSurveyMetaAiAnalyticsData_SideBySideSurveyCTAClickEventData)(nil),       // 102: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyCTAClickEventData
	(*BotFeedbackMessage_SideBySideSurveyMetadata_SidebySideSurveyMetaAiAnalyticsData_SideBySideSurveyCTAImpressionEventData)(nil),  // 103: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyCTAImpressionEventData
	(*AIHomeState_AIHomeOption)(nil),                                                                                                // 104: WAWebProtobufsAICommon.AIHomeState.AIHomeOption
	(*BotRenderingMetadata_Keyword)(nil),                                                                                            // 105: WAWebProtobufsAICommon.BotRenderingMetadata.Keyword
	(*InThreadSurveyMetadata_InThreadSurveyPrivacyStatementPart)(nil),                                                               // 106: WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyPrivacyStatementPart
	(*InThreadSurveyMetadata_InThreadSurveyOption)(nil),                                                                             // 107: WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyOption
	(*InThreadSurveyMetadata_InThreadSurveyQuestion)(nil),                                                                           // 108: WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyQuestion
	(*BotUnifiedResponseMutation_MediaDetailsMetadata)(nil),                                                                         // 109: WAWebProtobufsAICommon.BotUnifiedResponseMutation.MediaDetailsMetadata
	(*BotUnifiedResponseMutation_SideBySideMetadata)(nil),                                                                           // 110: WAWebProtobufsAICommon.BotUnifiedResponseMutation.SideBySideMetadata
	(*AIProvenance_Metadata)(nil),                                                                                                   // 111: WAWebProtobufsAICommon.AIProvenance.Metadata
	(*waCommon.MessageKey)(nil),                                                                                                     // 112: WACommon.MessageKey
}
var file_waAICommon_WAWebProtobufsAICommon_proto_depIdxs = []int32{
	...
	112, // 2: WAWebProtobufsAICommon.BotPluginMetadata.parentPluginMessageKey:type_name -> WACommon.MessageKey
	...
	9,   // 7: WAWebProtobufsAICommon.BotPromotionMessageMetadata.promotionType:type_name -> WAWebProtobufsAICommon.BotPromotionMessageMetadata.BotPromotionType
	10,  // 8: WAWebProtobufsAICommon.BotMediaMetadata.orientationType:type_name -> WAWebProtobufsAICommon.BotMediaMetadata.OrientationType
	112, // 9: WAWebProtobufsAICommon.BotReminderMetadata.requestMessageKey:type_name -> WACommon.MessageKey
	12,  // 10: WAWebProtobufsAICommon.BotReminderMetadata.action:type_name -> WAWebProtobufsAICommon.BotReminderMetadata.ReminderAction
	11,  // 11: WAWebProtobufsAICommon.BotReminderMetadata.frequency:type_name -> WAWebProtobufsAICommon.BotReminderMetadata.ReminderFrequency
	14,  // 12: WAWebProtobufsAICommon.BotModelMetadata.modelType:type_name -> WAWebProtobufsAICommon.BotModelMetadata.ModelType
	13,  // 13: WAWebProtobufsAICommon.BotModelMetadata.premiumModelStatus:type_name -> WAWebProtobufsAICommon.BotModelMetadata.PremiumModelStatus
	88,  // 14: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.stepsMetadata:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata
	18,  // 15: WAWebProtobufsAICommon.BotCapabilityMetadata.capabilities:type_name -> WAWebProtobufsAICommon.BotCapabilityMetadata.BotCapabilityType
	19,  // 16: WAWebProtobufsAICommon.BotModeSelectionMetadata.mode:type_name -> WAWebProtobufsAICommon.BotModeSelectionMetadata.BotUserSelectionMode
	92,  // 17: WAWebProtobufsAICommon.BotQuotaMetadata.botFeatureQuotaMetadata:type_name -> WAWebProtobufsAICommon.BotQuotaMetadata.BotFeatureQuotaMetadata
	21,  // 18: WAWebProtobufsAICommon.BotImagineMetadata.imagineType:type_name -> WAWebProtobufsAICommon.BotImagineMetadata.ImagineType
	22,  // 19: WAWebProtobufsAICommon.BotAgeCollectionMetadata.ageCollectionType:type_name -> WAWebProtobufsAICommon.BotAgeCollectionMetadata.AgeCollectionType
	93,  // 20: WAWebProtobufsAICommon.BotSourcesMetadata.sources:type_name -> WAWebProtobufsAICommon.BotSourcesMetadata.BotSourceItem
	24,  // 21: WAWebProtobufsAICommon.BotMessageOrigin.type:type_name -> WAWebProtobufsAICommon.BotMessageOrigin.BotMessageOriginType
	95,  // 22: WAWebProtobufsAICommon.AIThreadInfo.serverInfo:type_name -> WAWebProtobufsAICommon.AIThreadInfo.AIThreadServerInfo
	94,  // 23: WAWebProtobufsAICommon.AIThreadInfo.clientInfo:type_name -> WAWebProtobufsAICommon.AIThreadInfo.AIThreadClientInfo
	112, // 24: WAWebProtobufsAICommon.BotFeedbackMessage.messageKey:type_name -> WACommon.MessageKey
	29,  // 25: WAWebProtobufsAICommon.BotFeedbackMessage.kind:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.BotFeedbackKind
	26,  // 26: WAWebProtobufsAICommon.BotFeedbackMessage.kindReport:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.ReportKind
	96,  // 27: WAWebProtobufsAICommon.BotFeedbackMessage.sideBySideSurveyMetadata:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata
	30,  // 28: WAWebProtobufsAICommon.BotDocumentMessageMetadata.pluginType:type_name -> WAWebProtobufsAICommon.BotDocumentMessageMetadata.DocumentPluginType
	104, // 29: WAWebProtobufsAICommon.AIHomeState.capabilityOptions:type_name -> WAWebProtobufsAICommon.AIHomeState.AIHomeOption
	104, // 30: WAWebProtobufsAICommon.AIHomeState.conversationOptions:type_name -> WAWebProtobufsAICommon.AIHomeState.AIHomeOption
	32,  // 31: WAWebProtobufsAICommon.BotInfrastructureDiagnostics.botBackend:type_name -> WAWebProtobufsAICommon.BotInfrastructureDiagnostics.BotBackend
	54,  // 32: WAWebProtobufsAICommon.BotSuggestedPromptMetadata.promptSuggestions:type_name -> WAWebProtobufsAICommon.BotPromptSuggestions
	55,  // 33: WAWebProtobufsAICommon.BotPromptSuggestions.suggestions:type_name -> WAWebProtobufsAICommon.BotPromptSuggestion
	34,  // 34: WAWebProtobufsAICommon.BotLinkedAccountsMetadata.accounts:type_name -> WAWebProtobufsAICommon.BotLinkedAccount
	58,  // 35: WAWebProtobufsAICommon.BotMemoryMetadata.addedFacts:type_name -> WAWebProtobufsAICommon.BotMemoryFact
	58,  // 36: WAWebProtobufsAICommon.BotMemoryMetadata.removedFacts:type_name -> WAWebProtobufsAICommon.BotMemoryFact
	35,  // 37: WAWebProtobufsAICommon.BotSignatureVerificationMetadata.proofs:type_name -> WAWebProtobufsAICommon.BotSignatureVerificationUseCaseProof
	105, // 38: WAWebProtobufsAICommon.BotRenderingMetadata.keywords:type_name -> WAWebProtobufsAICommon.BotRenderingMetadata.Keyword
	...
	37,  // 42: WAWebProtobufsAICommon.BotMemuMetadata.faceImages:type_name -> WAWebProtobufsAICommon.BotMediaMetadata
	108, // 43: WAWebProtobufsAICommon.InThreadSurveyMetadata.questions:type_name -> WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyQuestion
	106, // 44: WAWebProtobufsAICommon.InThreadSurveyMetadata.privacyStatementParts:type_name -> WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyPrivacyStatementPart
	47,  // 45: WAWebProtobufsAICommon.BotMessageOriginMetadata.origins:type_name -> WAWebProtobufsAICommon.BotMessageOrigin
	110, // 46: WAWebProtobufsAICommon.BotUnifiedResponseMutation.sbsMetadata:type_name -> WAWebProtobufsAICommon.BotUnifiedResponseMutation.SideBySideMetadata
	109, // 47: WAWebProtobufsAICommon.BotUnifiedResponseMutation.mediaDetailsMetadataList:type_name -> WAWebProtobufsAICommon.BotUnifiedResponseMutation.MediaDetailsMetadata
	69,  // 48: WAWebProtobufsAICommon.AIMetadataOperation.hatchMetadataSync:type_name -> WAWebProtobufsAICommon.HatchMetadataSync
	33,  // 49: WAWebProtobufsAICommon.BotMetadata.pluginMetadata:type_name -> WAWebProtobufsAICommon.BotPluginMetadata
	53,  // 50: WAWebProtobufsAICommon.BotMetadata.suggestedPromptMetadata:type_name -> WAWebProtobufsAICommon.BotSuggestedPromptMetadata
	62,  // 51: WAWebProtobufsAICommon.BotMetadata.sessionMetadata:type_name -> WAWebProtobufsAICommon.BotSessionMetadata
	63,  // 52: WAWebProtobufsAICommon.BotMetadata.memuMetadata:type_name -> WAWebProtobufsAICommon.BotMemuMetadata
	38,  // 53: WAWebProtobufsAICommon.BotMetadata.reminderMetadata:type_name -> WAWebProtobufsAICommon.BotReminderMetadata
	39,  // 54: WAWebProtobufsAICommon.BotMetadata.modelMetadata:type_name -> WAWebProtobufsAICommon.BotModelMetadata
	40,  // 55: WAWebProtobufsAICommon.BotMetadata.progressIndicatorMetadata:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata
	41,  // 56: WAWebProtobufsAICommon.BotMetadata.capabilityMetadata:type_name -> WAWebProtobufsAICommon.BotCapabilityMetadata
	44,  // 57: WAWebProtobufsAICommon.BotMetadata.imagineMetadata:type_name -> WAWebProtobufsAICommon.BotImagineMetadata
	57,  // 58: WAWebProtobufsAICommon.BotMetadata.memoryMetadata:type_name -> WAWebProtobufsAICommon.BotMemoryMetadata
	60,  // 59: WAWebProtobufsAICommon.BotMetadata.renderingMetadata:type_name -> WAWebProtobufsAICommon.BotRenderingMetadata
	61,  // 60: WAWebProtobufsAICommon.BotMetadata.botMetricsMetadata:type_name -> WAWebProtobufsAICommon.BotMetricsMetadata
	56,  // 61: WAWebProtobufsAICommon.BotMetadata.botLinkedAccountsMetadata:type_name -> WAWebProtobufsAICommon.BotLinkedAccountsMetadata
	46,  // 62: WAWebProtobufsAICommon.BotMetadata.richResponseSourcesMetadata:type_name -> WAWebProtobufsAICommon.BotSourcesMetadata
	36,  // 63: WAWebProtobufsAICommon.BotMetadata.botPromotionMessageMetadata:type_name -> WAWebProtobufsAICommon.BotPromotionMessageMetadata
	42,  // 64: WAWebProtobufsAICommon.BotMetadata.botModeSelectionMetadata:type_name -> WAWebProtobufsAICommon.BotModeSelectionMetadata
	43,  // 65: WAWebProtobufsAICommon.BotMetadata.botQuotaMetadata:type_name -> WAWebProtobufsAICommon.BotQuotaMetadata
	45,  // 66: WAWebProtobufsAICommon.BotMetadata.botAgeCollectionMetadata:type_name -> WAWebProtobufsAICommon.BotAgeCollectionMetadata
	59,  // 67: WAWebProtobufsAICommon.BotMetadata.verificationMetadata:type_name -> WAWebProtobufsAICommon.BotSignatureVerificationMetadata
	66,  // 68: WAWebProtobufsAICommon.BotMetadata.unifiedResponseMutation:type_name -> WAWebProtobufsAICommon.BotUnifiedResponseMutation
	65,  // 69: WAWebProtobufsAICommon.BotMetadata.botMessageOriginMetadata:type_name -> WAWebProtobufsAICommon.BotMessageOriginMetadata
	64,  // 70: WAWebProtobufsAICommon.BotMetadata.inThreadSurveyMetadata:type_name -> WAWebProtobufsAICommon.InThreadSurveyMetadata
	48,  // 71: WAWebProtobufsAICommon.BotMetadata.botThreadInfo:type_name -> WAWebProtobufsAICommon.AIThreadInfo
	83,  // 72: WAWebProtobufsAICommon.BotMetadata.regenerateMetadata:type_name -> WAWebProtobufsAICommon.AIRegenerateMetadata
	84,  // 73: WAWebProtobufsAICommon.BotMetadata.sessionTransparencyMetadata:type_name -> WAWebProtobufsAICommon.SessionTransparencyMetadata
	50,  // 74: WAWebProtobufsAICommon.BotMetadata.botDocumentMessageMetadata:type_name -> WAWebProtobufsAICommon.BotDocumentMessageMetadata
	76,  // 75: WAWebProtobufsAICommon.BotMetadata.botGroupMetadata:type_name -> WAWebProtobufsAICommon.BotGroupMetadata
	78,  // 76: WAWebProtobufsAICommon.BotMetadata.botRenderingConfigMetadata:type_name -> WAWebProtobufsAICommon.BotRenderingConfigMetadata
	52,  // 77: WAWebProtobufsAICommon.BotMetadata.botInfrastructureDiagnostics:type_name -> WAWebProtobufsAICommon.BotInfrastructureDiagnostics
	67,  // 78: WAWebProtobufsAICommon.BotMetadata.aiMediaCollectionMetadata:type_name -> WAWebProtobufsAICommon.AIMediaCollectionMetadata
	71,  // 79: WAWebProtobufsAICommon.BotMetadata.commandMetadata:type_name -> WAWebProtobufsAICommon.BotCommandMetadata
	72,  // 80: WAWebProtobufsAICommon.BotMetadata.resolvedToolCallMetadata:type_name -> WAWebProtobufsAICommon.BotResolvedToolCallMetadata
	75,  // 81: WAWebProtobufsAICommon.BotMetadata.subscriptionUpsellMetadata:type_name -> WAWebProtobufsAICommon.AISubscriptionUpsellMetadata
	73,  // 82: WAWebProtobufsAICommon.BotMetadata.pttPromptMetadata:type_name -> WAWebProtobufsAICommon.BotPttPromptMetadata
	77,  // 83: WAWebProtobufsAICommon.BotMetadata.botHistoryShareMetadata:type_name -> WAWebProtobufsAICommon.BotHistoryShareMetadata
	3,   // 84: WAWebProtobufsAICommon.AISubscriptionUpsellMetadata.requestType:type_name -> WAWebProtobufsAICommon.AISubscriptionRequestType
	79,  // 85: WAWebProtobufsAICommon.BotGroupMetadata.participantsMetadata:type_name -> WAWebProtobufsAICommon.BotGroupParticipantMetadata
	79,  // 86: WAWebProtobufsAICommon.BotHistoryShareMetadata.participantsMetadata:type_name -> WAWebProtobufsAICommon.BotGroupParticipantMetadata
	0,   // 87: WAWebProtobufsAICommon.BotMessageSharingInfo.botEntryPointOrigin:type_name -> WAWebProtobufsAICommon.BotMetricsEntryPoint
	112, // 88: WAWebProtobufsAICommon.AIRegenerateMetadata.messageKey:type_name -> WACommon.MessageKey
	4,   // 89: WAWebProtobufsAICommon.SessionTransparencyMetadata.sessionTransparencyType:type_name -> WAWebProtobufsAICommon.SessionTransparencyType
	86,  // 90: WAWebProtobufsAICommon.BotAgentMetadata.deepLinkMetadata:type_name -> WAWebProtobufsAICommon.BotAgentDeepLinkMetadata
	111, // 91: WAWebProtobufsAICommon.AIProvenance.c2PaMetadata:type_name -> WAWebProtobufsAICommon.AIProvenance.Metadata
	111, // 92: WAWebProtobufsAICommon.AIProvenance.iptcMetadata:type_name -> WAWebProtobufsAICommon.AIProvenance.Metadata
	89,  // 93: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.sourcesMetadata:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata
	16,  // 94: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.status:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.PlanningStepStatus
	90,  // 95: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.sections:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningStepSectionMetadata
	17,  // 96: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata.provider:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourcesMetadata.BotPlanningSearchSourceProvider
	91,  // 97: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningStepSectionMetadata.sourcesMetadata:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourceMetadata
	15,  // 98: WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotPlanningSearchSourceMetadata.provider:type_name -> WAWebProtobufsAICommon.BotProgressIndicatorMetadata.BotPlanningStepMetadata.BotSearchSourceProvider
	20,  // 99: WAWebProtobufsAICommon.BotQuotaMetadata.BotFeatureQuotaMetadata.featureType:type_name -> WAWebProtobufsAICommon.BotQuotaMetadata.BotFeatureQuotaMetadata.BotFeatureType
	23,  // 100: WAWebProtobufsAICommon.BotSourcesMetadata.BotSourceItem.provider:type_name -> WAWebProtobufsAICommon.BotSourcesMetadata.BotSourceItem.SourceProvider
	25,  // 101: WAWebProtobufsAICommon.AIThreadInfo.AIThreadClientInfo.type:type_name -> WAWebProtobufsAICommon.AIThreadInfo.AIThreadClientInfo.AIThreadType
	98,  // 102: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.analyticsData:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SideBySideSurveyAnalyticsData
	97,  // 103: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.metaAiAnalyticsData:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData
	103, // 104: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.ctaImpressionEvent:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyCTAImpressionEventData
	102, // 105: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.ctaClickEvent:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyCTAClickEventData
	101, // 106: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.cardImpressionEvent:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyCardImpressionEventData
	100, // 107: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.responseEvent:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyResponseEventData
	99,  // 108: WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.abandonEvent:type_name -> WAWebProtobufsAICommon.BotFeedbackMessage.SideBySideSurveyMetadata.SidebySideSurveyMetaAiAnalyticsData.SideBySideSurveyAbandonEventData
	31,  // 109: WAWebProtobufsAICommon.AIHomeState.AIHomeOption.type:type_name -> WAWebProtobufsAICommon.AIHomeState.AIHomeOption.AIHomeActionType
	107, // 110: WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyQuestion.questionOptions:type_name -> WAWebProtobufsAICommon.InThreadSurveyMetadata.InThreadSurveyOption
	37,  // 111: WAWebProtobufsAICommon.BotUnifiedResponseMutation.MediaDetailsMetadata.highResMedia:type_name -> WAWebProtobufsAICommon.BotMediaMetadata
	37,  // 112: WAWebProtobufsAICommon.BotUnifiedResponseMutation.MediaDetailsMetadata.previewMedia:type_name -> WAWebProtobufsAICommon.BotMediaMetadata
